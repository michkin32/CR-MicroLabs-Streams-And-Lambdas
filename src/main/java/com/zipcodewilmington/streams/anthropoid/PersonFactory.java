...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        ArrayList<Person> peeps = new ArrayList<Person>(listSize);
        Arrays.stream(new int[listSize]).forEach((x) -> peeps.add(createRandomPerson()));
    ...
    public Stream<Person> createPersonStream(int streamCount) {
       // Stream<Person> personStream = Arrays.stream();
